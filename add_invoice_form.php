...
<div class="row">
    <div class="col-sm-6" id="company_wrapper"> <!-- Changed div ID -->
        <div class="form-group row">
            <label for="company_id" class="col-sm-3 col-form-label">Company Name:<i class="text-danger">*</i></label>
            <div class="col-sm-6">
                <select name="company_id" id="company_id" class="form-control" required="" tabindex="1">
